...
import 'package:sleeptales/widgets/collection_item_grid.dart';
...
class CollectionListScreen extends StatefulWidget {
  ...
  const CollectionListScreen({super.key,required this.heading,required this.list,required this.panelFunction});
                          ...
                          GridView.builder(
                              ...
                              itemBuilder: (BuildContext context, int index) {
                                return CollectionItemGrid(
                                  ...
                                  mp3Category: widget.list[index].collectionCategory[0].categoryName,
                                  tap: (){
                                    pushName(context, TrackListScreen(heading: widget.list[index].collectionTitle,list: widget.list[index].collectionTracks,panelFunction: widget.panelFunction,));
                                  },
                                ); }
                          ),

...
import 'package:sleeptales/screens/about_screen.dart';
import 'package:sleeptales/screens/change_language.dart';
import 'package:sleeptales/screens/change_password_screen.dart';
import 'package:sleeptales/screens/delete_account.dart';
import 'package:sleeptales/screens/downloads_screen.dart';
import 'package:sleeptales/screens/edit_profile_screen.dart';
import 'package:sleeptales/screens/favorite_playlist_screen.dart';
import 'package:sleeptales/screens/favorites_screen.dart';
import 'package:sleeptales/screens/manage_subscription.dart';
import 'package:sleeptales/screens/reminders_screen.dart';
      ...
      body: SingleChildScrollView(
        ...
        children: [
                ...
                Column(
                  ...
                  children: [
                    ...
                    TextButton(
                      ...
                      child: Text(translation(context).editProfile,style: TextStyle(color: Colors.white),),
                    ),
                  ],
                ),
              ],
          ...
          Padding(padding: EdgeInsets.symmetric(vertical: 12.h,horizontal: 8.w),
            child:Divider(height: 3.0,color: lightBlueColor,),
          ),
          ListTile(
            leading: Icon(Icons.favorite,color: Colors.white,size: 20.h),
            title: Text(translation(context).favoriteList),
            trailing: Icon(Icons.arrow_forward_ios,color: Colors.white,size: 24.h,),
            onTap: () {
              pushName(context, FavoritesScreen(panelFunction: widget.panelFunction,));
          ...
          ListTile(
            ...
            trailing: Icon(Icons.arrow_forward_ios,color: Colors.white,size: 24.h,),
            onTap: () {
              pushName(context, FavoritePlaylistScreen(panelFunction: widget.panelFunction,));
          ...
          ListTile(
            leading: Icon(Icons.info,color: Colors.white,size: 20.h,),
          ...
          ListTile(
            leading: Icon(Icons.account_circle,color: Colors.white,size: 20.h,),
          ...
          child:   Align(alignment: Alignment.centerLeft,
            child:TextButton(onPressed: (){
              logout(context);
                ...
                , child: Text(translation(context).logout,textAlign: TextAlign.start,style: TextStyle(decoration: TextDecoration.underline,color: Colors.white,fontSize: 18.sp),)),

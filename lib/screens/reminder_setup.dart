...
class ReminderSetupScreen extends StatefulWidget {
  ...
  final String description2;
   const ReminderSetupScreen({Key? key,required this.heading,required this.type,required this.reminderID,required this.description,required this.description2,required this.notificationDescription}) : super(key: key);
          ...
          child: SingleChildScrollView(
              child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      TopBar(heading: widget.heading, onPress: () {
                      ...
                      Center(
                        child: SizedBox(
                          ...
                          child: ElevatedButton.icon(
                            style: ButtonStyle(
                              padding: MaterialStateProperty.all<EdgeInsets>(EdgeInsets.symmetric(vertical: 10.h,horizontal: 16.w)),
                            ...
                            if(value){
                              if(widget.type == 1){
                                if(selectedDays.every((day) => day == false)){
                                  ...
                                  setWeeklyReminderNotification(widget.heading, widget.notificationDescription, selectedDays, _selectedTime);
                                ...
                                setReminderNotification(widget.heading, widget.notificationDescription, _selectedTime);
                                saveReminderValue(widget.heading, value);
                              }
                      ...
                      CustomButton(title: "Save settings", onPress: () {
                        if (widget.type == 1) {
                          if (selectedDays.every((day) => day == false)) {
...
// Define a method to show the daily reminder notification
  Future<void> setReminderNotification(String title,String reminderDescription,TimeOfDay time) async {
...
// iOS notification details
    ...
    NotificationDetails(android: androidPlatformChannelSpecifics,iOS: initializationSettingsDarwin);

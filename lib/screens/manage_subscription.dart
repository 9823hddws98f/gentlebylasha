...
class ManageSubscriptionScreen extends StatefulWidget {
  final String? email;
  const ManageSubscriptionScreen({Key? key,this.email}) : super(key: key);
          ...
          child:SingleChildScrollView(
              child: Padding(
                  ...
                  child:Column(
                    ...
                    children: [
                      TopBar(heading: "Manage Subscription", onPress: (){

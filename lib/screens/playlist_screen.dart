...
import 'package:sleeptales/notifiers/play_button_notifier.dart';
...
class PlayListScreen extends StatefulWidget {
  ...
  PlayListScreen({super.key,required this.list,required this.panelFunction,required this.block});
...
class _TrackListScreenState extends State<PlayListScreen> {
  ...
  void _onPlaylistChanged() {
    setState(() {
      ...
      currentPlaylistIsPlaying = currentPlayingList.every((id) => widget.list.any((track) => track.trackId == id));
    });
  }
          ...
          color: seriesDividerColor,
              ...
              ListView.separated(
                ...
                itemBuilder: (BuildContext context, int index) {
                  ...
                  SeriesTrackListWidget(audioTrack:widget.list[index],tap: (){
                    getIt<PageManager>().loadPlaylist(widget.list,index);
                    widget.panelFunction(false);
                  },onTapPlayPause: (){
                    if(currentPlaylistIsPlaying && currentMediaItem.id == widget.list[index].trackId && playing){
                      getIt<PageManager>().pause();
                    }else{
                      getIt<PageManager>().loadPlaylist(widget.list,index);
                      getIt<PageManager>().play();
                  ...
                  currentPlaying: (currentPlaylistIsPlaying && currentMediaItem.id == widget.list[index].trackId && playing)?true:false,
                  ):


                  SeriesTrackListImageWidget(audioTrack:widget.list[index],tap: (){
                      getIt<PageManager>().loadPlaylist(widget.list,index);
                      widget.panelFunction(false);

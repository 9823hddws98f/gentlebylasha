        ...
        child: SizedBox(
            child: Padding(
                ...
                child:Column(
                  ...
                  children: [
                    TopBar(heading: translation(context).favoriteList, onPress: (){
                    ...
                    Expanded(
                                ...
                                return TrackListItemSmall(
                                  ...
                                  tap: (){
                                    getIt<PageManager>().playSinglePlaylist(MediaItem(
                                      ...
                                      extras: {'url': favoriteList[index].trackUrl,'id':favoriteList[index].trackId,'categories':favoriteList[index].categories},
                     ...
                     Expanded(child:Column(
                       ...
                       children: [
                         ...
                         SizedBox(height: 5.h,),
                         Text("You have not added any favorites yet",style: TextStyle(fontSize: 16.sp),)
                       ],
                     ))]
